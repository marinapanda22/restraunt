...
class CavesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cafe" do
    assert_difference('Cafe.count') do
      post caves_url, params: { cafe: { description: @cafe.description, image: @cafe.image, title: @cafe.title } }
    end
  ...
  test "should update cafe" do
    patch cafe_url(@cafe), params: { cafe: { description: @cafe.description, image: @cafe.image, title: @cafe.title } }
